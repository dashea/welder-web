...
class CreateImage extends React.Component {
  ...
  handleCreateImage() {
    ...
    NotificationsApi.displayNotification(this.props.blueprint, _('creating'));
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            <div className="modal-header">
              ...
              <h4 className="modal-title" id="myModalLabel">{_("Create Image")}</h4>
            </div>
            ...
            <div className="modal-footer">
              <button type="button" className="btn btn-default" data-dismiss="modal">{_("Cancel")}</button>
              <button type="button" className="btn btn-primary" onClick={this.handleCreateImage}>{_("Create")}</button>
            </div>
          </div>
        </div>
      </div>
